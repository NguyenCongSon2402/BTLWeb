        ...
        <body>
            <script>
                function cityChange(cityName) {
                    ...
                    document.getElementById("shipValue").innerHTML = shipPrice + " VND";
                ...
                <div class="container wow fadeIn">
                            ...
                            <div class="card">
                                ...
                                <form class="card-body" action="finish" method="post">
                                    ...
                                    <div class="md-form mb-5">
                                        ...
                                        <input type="text" name="email" id="email" class="form-control" placeholder="youremail@example.com" required>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <h4 class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <span class="badge badge-secondary badge-pill">${c.countNumCart(sessionScope.account.id)}</span>
                        </h4>
                        ...
                        <ul class="list-group mb-3 z-depth-1">
                            ...
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <span class="text-muted" id="shipValue">15.000 VND</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <strong>Total</strong>
